    ...
    <div class="container about-container animate__animated animate__fadeIn">
        ...
        <div class="row">
            <div class="col-md-6 mb-4">
                <!-- Slideshow / Carousel -->
                <div id="aboutCarousel" class="carousel slide animate__animated animate__zoomIn" data-ride="carousel" data-interval="3000">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="assets/about-image1.jpg" class="d-block w-100" alt="Community Engagement">
                        </div>
                        <div class="carousel-item">
                            <img src="assets/about-image2.jpg" class="d-block w-100" alt="Advanced Fitness Tracking">
                        </div>
                        <div class="carousel-item">
                            <img src="assets/about-image3.jpg" class="d-block w-100" alt="Professional Trainers">
                        </div>
                        <div class="carousel-item">
                            <img src="assets/about-image4.jpg" class="d-block w-100" alt="State-of-the-Art Facilities">
                        </div>
                        <div class="carousel-item">
                            <img src="assets/about-image5.jpg" class="d-block w-100" alt="Fitness for Everyone">
                        </div>
                    </div>
